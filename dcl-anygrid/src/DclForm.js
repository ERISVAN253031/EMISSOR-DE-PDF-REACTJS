...
const DclForm = () => {
    ...
    const generatePdf = async () => {
        ...
        page.drawLine({ start: { x: (600 - lineLength) / 2, y: yPosition }, end: { x: (600 + lineLength) / 2, y: yPosition }, color: rgb(0, 0, 0), thickness: 1 });
    ...
    return (
        <div className="form-container">
            ...
            <div className="section">
                ...
                <input type="text" placeholder="Bairro" value={bairroRemetente} onChange={(e) => setBairroRemetente(e.target.value)} />
                <InputMask mask="99999-999" maskChar={null} placeholder="CEP" value={cepRemetente} onChange={handleCepChange} />
                <InputMask mask="(99) 99999-9999" maskChar={null} placeholder="Contato" value={contatoRemetente} onChange={(e) => setContatoRemetente(e.target.value)} />
            </div>

            <div className="section">
                <h2>Destinatário</h2>
                <input type="text" placeholder="Nome" value={destinatario} onChange={(e) => setDestinatario(e.target.value)} />
                <InputMask mask="99.999.999/9999-99" maskChar={null} placeholder="CNPJ" value={cnpjDestinatario} onChange={(e) => setCnpjDestinatario(e.target.value)} />
                <input type="text" placeholder="Cidade" value={cidadeDestinatario} onChange={(e) => setCidadeDestinatario(e.target.value)} />
                <input type="text" placeholder="UF" value={ufDestinatario} onChange={(e) => setUfDestinatario(e.target.value)} />
                <input type="text" placeholder="Endereço" value={enderecoDestinatario} onChange={(e) => setEnderecoDestinatario(e.target.value)} />
                <input type="text" placeholder="Bairro" value={bairroDestinatario} onChange={(e) => setBairroDestinatario(e.target.value)} />
                <InputMask mask="99999-999" maskChar={null} placeholder="CEP" value={cepDestinatario} onChange={(e) => setCepDestinatario(e.target.value)} />
                <InputMask mask="(99) 99999-9999" maskChar={null} placeholder="Contato" value={contatoDestinatario} onChange={(e) => setContatoDestinatario(e.target.value)} />
            </div>
